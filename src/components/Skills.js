...
// Define the skills data structure updated with the new list and categories
const skillsData = [
  {
...
const getProficiencyClass = (level) => {
  switch (level) {
    case "Expert":
      return "bg-success text-dark"; // Green badge
    case "Advanced":
      return "bg-primary text-white"; // Blue badge
    case "Proficient":
      return "bg-warning text-dark"; // Yellow/Orange badge
    case "Familiar":
      return "bg-info text-dark"; // Cyan badge
    default:
                  ...
                  <ul className="list-group list-group-flush">
                    {categoryItem.skills.map((skill) => (
                      ...
                      >
                        ...
                        {/* Proficiency Tag using Bootstrap Badges */}
                        <span
